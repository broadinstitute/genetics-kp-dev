...
import openapi_server.dcc.attribute_utils as at_utils
...
def build_attribute(name_original, value, value_type, id_source=None, log=False):
    '''
    ...
    elif value_type in [at_utils.BIOLINK_CLASSIFICATION, at_utils.BIOLINK_AGENT_TYPE, at_utils.BIOLINK_KNOWLEDGE_LEVEL]:
        type_value = at_utils.TYPE_VALUE_STRING
    elif value_type in [at_utils.BIOLINK_PUBLICATION]:
        type_value = at_utils.TYPE_VALUE_PUBLICATIONS
    ...
    attribute_result = Attribute(attribute_type_id=value_type, attribute_source=source, original_attribute_name=name_original, value=value, attributes=[], value_type_id=type_value)
