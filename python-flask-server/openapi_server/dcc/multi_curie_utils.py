...
def sub_query_mcq(trapi_query: Query, log=False):
    ...
    trapi_query.message.knowledge_graph = tutils.build_knowledge_graph(map_edges=map_edges, map_nodes=map_nodes, log=True)
...
def calculate_from_results(list_genes, log=False):
    '''
    will do the algorithmic calculation of the results 
    '''
    # initialize
    map_phenotype_weight = {}
    ...
    # build list of maps, with gene as key
