...
from openapi_server.dcc.biolink_utils import BiolinkAncestrySingleton
...
def predicates_get():  # noqa: E501
    # get the predicates map
    biolink = BiolinkAncestrySingleton.getInstance()
    predicates_map = biolink.predicate_map

    # return
    return predicates_map

# def predicates_getOld2():  # noqa: E501
#     """Get supported relationships by source and target
