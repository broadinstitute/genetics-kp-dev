...
# opentelemetry
RUN pip3 install opentelemetry-sdk==1.22.0
RUN pip3 install opentelemetry-instrumentation-flask==0.43b0
RUN pip3 install opentelemetry-exporter-jaeger==1.21.0
RUN pip3 install opentelemetry-instrumentation-requests==0.43b0
